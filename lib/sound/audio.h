...
bool audio_PlayObjStaticTrack(SimpleObject *psObj, int iTrack);
bool audio_PlayObjStaticTrackCallback(SimpleObject *psObj, int iTrack, AUDIO_CALLBACK pUserCallback);
bool audio_PlayObjDynamicTrack(SimpleObject *psObj, int iTrack, AUDIO_CALLBACK pUserCallback);
void audio_StopObjTrack(SimpleObject *psObj, int iTrack);
