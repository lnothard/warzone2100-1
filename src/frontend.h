...
enum tMode
{
	...
	// 6
	FORCESELECT,
	// 7 MULTIPLAYER, Force design screen
	STARTGAME,
	// 8 Fire up the game
	SHOWINTRO,
	// 9 reshow the intro
	...
	// 10 leaving game
	LOADSAVEGAME,
	// 11 loading a save game
	KEYMAP,
	// 12 keymap editor
	GRAPHICS_OPTIONS,
	// 13 graphics options menu
	AUDIO_AND_ZOOM_OPTIONS,
	// 14 audio and zoom options menu
	VIDEO_OPTIONS,
	// 15 video options menu
	MOUSE_OPTIONS,
	// 16 mouse options menu
	CAMPAIGNS,
	// 17 campaign selector
	MUSIC_MANAGER,
	// 18 music manager
	MULTIPLAY_OPTIONS,
	// 19 multiplay options menu
};
...
W_LABEL* addSideText(const std::shared_ptr<W_SCREEN>& screen, UDWORD formId, UDWORD id, UDWORD PosX, UDWORD PosY,
                     const char* txt);
...
enum
{
	...
	// player 7 buton
	FE_MP_PR,
	// Multiplayer player random button
	FE_MP_PMAX = FE_MP_PR + MAX_PLAYERS_IN_GUI,
	// Multiplayer player blah button
	...
	FRONTEND_GRAPHICSOPTIONS = 22000,
	...
	FRONTEND_AUDIO_AND_ZOOMOPTIONS = 23000,
	// Audio and Zoom Options Menu
	FRONTEND_3D_FX,
	// 3d sound volume
	FRONTEND_FX,
	// 2d (voice) sound volume
	FRONTEND_MUSIC,
	// music volume
	FRONTEND_SUBTITLES,
	...
	FRONTEND_KEYMAP = 26000,
	// Keymap menu

	FRONTEND_MUSICMANAGER = 27000,
	// Music manager menu

	FRONTEND_MULTIPLAYOPTIONS = 28000,
