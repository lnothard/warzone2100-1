...
bool objHasWeapon(const PersistentObject* psObj)
{
	//check if valid type
...
SensorStats* objActiveRadar(const PersistentObject* psObj)
{
...
bool objRadarDetector(const PersistentObject *psObj)
{
