...
struct MULTIPLAYERGAME
{
	...
	// The number of minutes without active play before a player should be considered "inactive". (0 = disable activity alerts)
...
#define MPFLAGS_MAX		0x3f
	...
	std::vector<MULTISTRUCTLIMITS> lastAppliedStructureLimits;
	// a bit of a hack to retain the structureLimits used when loading / starting a game
};
...
///< Print message to console saying a name changed.
