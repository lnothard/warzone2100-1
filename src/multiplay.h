...
WZ_DECL_WARN_UNUSED_RESULT GameObject *IdToPointer(UDWORD id, UDWORD player);
...
WZ_DECL_WARN_UNUSED_RESULT DroidStats *IdToTemplate(UDWORD tempId, UDWORD player);
...
void sendStructureInfo(Structure *psStruct, STRUCTURE_INFO structureInfo,
                       DroidStats *psTempl);

// droids . multibot
bool SendDroid(DroidStats *pTemplate, uint32_t x, uint32_t y, uint8_t player, uint32_t id, const INITIAL_DROID_ORDERS *initialOrders);
