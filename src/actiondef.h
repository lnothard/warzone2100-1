...
enum DROID_ACTION
{
	...
	DACTION_UNUSED_2,
	DACTION_TRANSPORTOUT,
	///< 11 move transporter offworld
	DACTION_TRANSPORTWAITTOFLYIN,
	...
	DACTION_WAITFORREARM,
	///< 33 waiting for rearm - VTOLS
	DACTION_MOVETOREARMPOINT,
