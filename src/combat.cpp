...
int arcOfFire(const PersistentObject*, const PersistentObject*, int, bool);
...
unsigned objSensorRange(const PersistentObject*);
              ...
              bool isDamagePerSecond, int minDamage)
{
	...
	const auto lastHit = psObj->timeLastHit;
