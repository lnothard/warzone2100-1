...
{
public:
  DroidStats *getObjectStatsAt(size_t objectIndex) const override;
  DroidStats *getStatsAt(size_t statsIndex) const override
	{
	...
	void updateData();
	void adjustFactoryProduction(DroidStats *manufactureOption, bool add);
